...
**Isaac Sim**: 
    - Hosts a working digital twin of an actuator, modeled with:
        a. Prismatic joints for linear motion.
        b. Fixed joints for rigid connections.
        c. Kinematic chains to simulate realistic mechanical behavior.
        d. Receives data from the Python bridge and updates the scene
**Python Script**: 
